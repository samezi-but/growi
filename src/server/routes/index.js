module.exports = function(crowi, app) {
  ...
  app.post('/_api/admin/security/passport-slack', loginRequired(crowi, app) , middleware.adminRequired() , csrf, form.admin.securityPassportSlack, admin.api.securityPassportSlackSetting);
